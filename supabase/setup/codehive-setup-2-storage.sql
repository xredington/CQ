-- CodeHive · one-shot database setup (part 2 of 2: storage buckets + policies)
-- Run AFTER part 1. If a policy line fails with 'must be owner of table
-- objects', create these policies in Dashboard → Storage → Policies instead.
